...
<!-- bootstrap -->
	...
	<script type="text/javascript">
		...
		function loadPage(orderid){
			$.ajax({
				type:'get',
				url:'/orderdetail/orderdetailbyorderid.controller?orderid='+ orderid,
				dataType:'JSON',
				contentType:'application/json',
				success: function(data){
					$("#showdetails").empty("");
					
					var table = $('#showdetails');
					
					table.append("<tr class='tr'><td align='center' colspan='4'><h5>訂單編號</h5></td></tr>");
					
					table.append("<tr><td align='center' colspan='4'>" + orderid + "</td></tr>");
					
					table.append("<tr class='tr'><td align='center'><h5>產品名稱</h5></td><td align='center'><h5>訂單數量</h5></td>" +
					"<td align='center'><h5>商品單價</h5></td><td align='center'><h5>商品總價</h5></td></tr>");
					
					$.each(data, function(i,n){
	  				  var tr = "<tr>" +
	  				           "<td align='center'>" + n.name + "</td>" +
	  	    			       "<td align='center'>" + n.quantity + "</td>" +
	  	    			       "<td align='center'>" + n.price + "</td>" +
	  	    			       "<td align='center'>" + n.psum + "</td>" +
	  				           "</tr>";
	  				  table.append(tr);
	  				});
				}
...
<body>
	...
	<h2 class="text-center" style="color:#800000;">訂單明細紀錄</h2>
	<hr>
	...
	<table style="width:800px;margin:auto;" class="table table-striped"  id="showdetails" border="1"></table>
	<br>
	<form  name="OrderForm" action="/order/ordercustomerorder.controller" method="GET">
