...
<h2 class="text-center" style="color:#800000;">查詢介面</h2>
	<hr>
	<form class="test-form" style="margin:auto;background:#F5F5F5;border-width:4.5px;border-style:outset;border-color:#880000;padding:55px;border-radius:3em" action="/food/foodquery.controller" method="post"
	id="From">
		<div class="form-container" >
			...
			<button style="border-width:0.01px;border-radius:0.3em;color:white;background-color:#0066FF;width:150px" type="submit" id="submit-btn" >依區間查詢</button>
			<br></div>
	<div class="text-center"><br>
	</form>
	
	<form class="" action="/food/foodqueryall.controller" method="post" id="FromAll">
		<button style="border-width:0.01px;border-radius:0.3em;color:white;background-color:#0066FF;width:150px"  type="submit" id="submit-all" name="submit-all" >查詢所有資料</button>
	</form></div>
		</div>
