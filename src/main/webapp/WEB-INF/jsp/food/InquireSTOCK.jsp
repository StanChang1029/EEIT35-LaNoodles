...
<div class="wrapper d-flex align-items-stretch">
	...
	<hr>
	<form style="margin:auto;background:#F5F5F5;border-width:4.5px;border-style:outset;border-color:#880000;padding:55px;border-radius:3em"class="test-form" action="/food/foodquerydate.controller" method="post"
	id="From">
	...
	<div class="form-footer">
			<button class="form-btn" type="submit" id="submitasdf" >依區間查詢</button>
	</form>
	
	<form class="" action="/food/foodselectsingle.controller" method="post" id="FromAll">
		<button class="form-btn" type="submit" id="submit-all" name="submit-all" >查詢所有資料</button>
	</form>
	</div>
	<!-- 大家的內容 END-->
