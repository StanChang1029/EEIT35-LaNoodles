...
<div style="width:800px;margin:auto;background:#F5F5F5;border-width:4.5px;border-style:outset;border-color:#880000;padding:55px;border-radius:3em">
			...
			<div style="text-align: center";>
				預約成功,至mail確認預約資訊,點擊按鈕返回預約介面

				<p></p>
				<a href="foodmember.controller"><input  style='border-width:0.01px;border-radius:0.3em;color:white;background-color:#E00000' type="button"
					name="goback" value="返回預約介面">
			</div>
	</div>		
