...
<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5">
			...
			<!-- 大家的內容 START-->
<h2 class="text-center" style="color:#800000;">預約更新</h2>
	<hr>

	
			<form class="test-form" style="width:1000px;margin:auto;background:#F5F5F5;border-width:4.5px;border-style:outset;border-color:#880000;padding:55px;border-radius:3em" method="Post"
				action="./food/foodupdate.controller">
				<%
...
<tr>
   <input type="hidden" name="id" value="<%=p_id%>">
				...
				<div class="form-footer">
					...
					<button class="btn btn-primary mr-3"  type="submit" id="submit-btn" disabled>修改確認</button>
					<a href="Inquire"><button class="btn btn-primary" type="button" id="submit-btn" >取消修改</button>
				</div>
