...
<script language="javascript">window.opener.document.location.reload()</script>
	...
	<hr>
				<div class="text-center" style="width:1200px;margin:auto;background:#F5F5F5;border-width:4.5px;border-style:outset;border-color:#880000;padding:35px;border-radius:3em">
					<table id="showproduct" border="1" class="table table-bordered"></table>
					<table id="showpage" class="table table-bordered">
						<tr>
							<td>Total Pages:${totalPages} Total Records:
								${totalElements}</td>
							<td colspan="3" align="right">Previous <c:forEach var="i"
									begin="1" end="${totalPages}" step="1">
									<button class="btn btn-primary" id="myPage" value="${i}"
    	...
    	$.ajax({
    		...
    		success: function(data){
    			...
    			if(data==null){
    				...
    				table.append("<tr id='ptitle'><th align='center' ><h5>ID</h5></th><th align='center'><h5>餐點</h5></th><th align='center'><h5>照片</h5></th><th align='center'><h5>價格</h5></th><th align='center'><h5>配料</h5></th><th align='center'><h5>特色</h5></th><th align='center'><h5>更新</h5></th><th align='center'><h5>刪除</h5></th></tr>");
    				
    				$.each(data, function(i,n){
    				  var tr = "<tr align='center'>" +
    				  			"<td align='center' width='35'>" + n.id + "</td>" +
    				           "<td align='center' width='150'><h5 class='h55'>" + n.dish + "</td>" + 
    				           ...
    				           "<td align='center' width='350'>" + n.feature + "</td>" +    				     
    				           "<td align='center' width='50'><a href='menuupdate1.controller?mid=" + n.id + "'><button type='button' class='btn btn-primary'>更新</button></a></td>" +
    				           "<td align='center' width='100'><button type='button' style='border-width:0.01px;border-radius:0.3em;color:white;background-color:#E00000	' onclick='deleteclick(" + n.id + ")' >刪除</button></td>" +    				           
    				           "</tr>";
    				  table.append(tr);
    				});
    			}
    ...
    function deleteclick(id) {
    	Swal.fire({
    		  ...
    		  if (result.isConfirmed) {
    		   ...
    		   $.ajax({
    		type:'get',
    		url:'/menu/menudeletebyid.controller?mid=' + id,    		
    		success: function(data){
    		   window.location.href="/menu/menumain.controller";
    		}
    		   })
    		  }
    		})
