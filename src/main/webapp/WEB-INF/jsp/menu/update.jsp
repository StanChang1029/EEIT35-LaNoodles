...
<br><h2 class="text-center" style="color:#800000;">更新拉麵菜單</h2>
	<hr>
...
<br><a href=" http://localhost:8080/menu/menumain.controller" class="pe-auto" ><button type="submit" class="btn btn-secondary" value="Send" >檢視菜單</button> </a>
<br>
<form action="menuupdate2.controller" method="post" enctype="multipart/form-data">
    ...
    <table  class="table table-hover">
        ...
        <td><h4>更新菜單:</h4></td>
            ...
            <tr>  
            <td>拉麵代碼:</td>
           <td><input id="dishcode2" type="text" name="menuId" value="${map.menuId}"></td> 
            </tr>
            <tr>              
            <td>拉麵名稱:</td>
           <td><input id="dishname2" type="text" name="menuDish" value="${map.menuDish}"></td>
            </tr>
            <tr>  
            <td>拉麵圖片:</td>
           <td><input id="dishphoto2" type="file"  name="menuPhoto" value="${map.menuPhoto}">        
           <img src='/images/${map.menuPhoto}'border=0 height=150 width=180></td>
           
            </tr>
            <tr>  
           <td>拉麵價格:</td>
           
           <td><input id="dishprice2" type="text" name="menuPrice" value="${map.menuPrice}"></td>   
            </tr>
            <tr>  
           <td>拉麵配料:</td>
           ...
           <input type="checkbox" name="menuItem" value="海苔">海苔&nbsp;&nbsp;
            ...
            <tr>
           <td>拉麵介紹:</td>
           <td><textarea style="resize:none;width:500px;height:150px;" id="dishFeature1" name="menuFeature" >${map.menuFeature}</textarea></td>                         
        </tr>
        <tr>        
           <td><button type="submit" value="Update" class="btn btn-primary" >更新</button> </td>
        </tr>
    </table>
</form>
</div>
