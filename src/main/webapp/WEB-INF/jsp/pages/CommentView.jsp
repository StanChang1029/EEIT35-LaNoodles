...
<!--     <link href="/carousel.css" rel="stylesheet"> -->
    ...
    <script src="https://cdn.tiny.cloud/1/dnjbj7v0lmacsq4cr2maf7g1zqblr2m8ai3lk6eoq5lfe62a/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    ...
    <script type="text/javascript">
       ...
       const urlParams2 = new URLSearchParams(window.location.search);
        ...
        var memberId;
        var username;
        var report_comment_id = 0;
        var insert_robot_id = null;
        var edit_robot_id = null;
        var report_robot_id = null;
...
console.log("G1+"+memberId);
console.log("G2+"+username);
        ...
        <script src="/js/CommentView2.js"></script>
...
<h2 class="text-center" style="color:#800000;">檢視評論</h2>
	<hr>
<div >
...
<c:choose>
	...
	<c:otherwise>
		<button id="OpenInsertCommentModalBox"  name="OpenInsertCommentModalBox" class="btn btn-dark" 
  ...
  <script src="/js/Scoring.js"></script><BR>
  <label>意見:</label>
  ...
  <button id="InsertCommentSend" data-dismiss="modal" class="btn btn-success" >送出評論</button>
  <button id="JustOnePressInsertComment" class="btn btn-warning" >一鍵送出</button>
  ...
  <div id = "editex"></div>
  <button id="EditCommentSend" data-dismiss="modal" class="btn btn-success">送出評論</button>
  <button id="JustOnePressEditComment" class="btn btn-warning">一鍵送出</button>
  ...
  <div id = "reportex"></div>
  <button id="ReportCommentSend" class="btn btn-success" data-dismiss="modal">送出檢舉</button>
  <button id="JustOnePressReportComment" class="btn btn-warning" >一鍵送出</button>
...
<%--     <c:if test="${memberProfile.memberProfileId == 1}">
    ...
    <BR><BR>
    <div style="font-size:20px;width:1200px;margin:auto;background:#F5F5F5;border-width:4.5px;border-style:outset;border-color:#880000;padding:25px;border-radius:3em">
    <table id="showproduct" border="1" class="flatTable"></table>
	</div>
